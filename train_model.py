...
#Select Features
dataset = dataset[['sepal_length', 'sepal_width', 'petal_length', 'petal_width', 'petal_legth_width_ratio', 'sepal_legth_width_ratio', 'target']]
...
labels = dataset.columns[:-1]  # Corrected the labels to exclude the 'target' column
...
ax.set_title('Random Forest Feature Importances', fontsize=title)
plt.tight_layout()
